...
export default class Request {
	 ...
	 * @example http://localhost:3000/trips?completed=true => { completed: "true" }
	 */
	getSearchParams = () => {
	 ...
	 * @example http://localhost:3000/trips/1 => 1
	 */
	getId = () => {
	...
	/**
	 * @returns The ID of the second parameter from the request URL.
	 * @example http://localhost:3000/trips/1/activities/2 => 2
	 */
	getSecondId = () => {
