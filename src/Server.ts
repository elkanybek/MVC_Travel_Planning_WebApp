...
import LuggageController from "./controllers/LuggageController";
...
export default class Server {
	...
	constructor(serverOptions: ServerOptions) {
		...
		this.activityController = new ActivityController(this.sql);
		this.budgetController = new BudgetController(this.sql);
		this.luggageController = new LuggageController(this.sql);
		this.tripController = new TripController(this.sql);
		this.userController = new UserController(this.sql);


		this.authController.registerRoutes(this.router);
		this.activityController.registerRoutes(this.router);
		this.budgetController.registerRoutes(this.router);
		this.luggageController.registerRoutes(this.router);
		this.tripController.registerRoutes(this.router);
